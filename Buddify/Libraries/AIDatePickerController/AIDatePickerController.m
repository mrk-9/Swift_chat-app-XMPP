...
static NSTimeInterval const AIAnimatedTransitionDuration = 0.3;
...
+ (AIDatePickerController *)pickerWithDate:(NSDate *)date selectedBlock:(AIDatePickerDateBlock)selectedBlock cancelBlock:(AIDatePickerVoidBlock)cancelBlock {
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (toViewController.view == self.view) {
        ...
        [UIView animateWithDuration:AIAnimatedTransitionDuration animations:^{
