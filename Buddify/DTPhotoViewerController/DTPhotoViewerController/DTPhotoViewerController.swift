...
public class DTPhotoViewerController: UIViewController, DTPhotoViewer, UIViewControllerTransitioningDelegate, UIScrollViewDelegate {
    ...
    private var _presentedImageViewSize: CGSize = CGSize.zero
        ...
        if let view = gesture.view {
            ...
            case .Changed:
                ...
                if scaleWhileDragging {
                    ...
                    _imageView.frame.size = CGSize(width: _presentedImageViewSize.width * scale, height: _presentedImageViewSize.height * scale)
                }
